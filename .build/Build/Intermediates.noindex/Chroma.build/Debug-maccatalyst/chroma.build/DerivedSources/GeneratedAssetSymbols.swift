...
extension DeveloperToolsSupport.ColorResource {
    ...
    static let launchPrimaryText = DeveloperToolsSupport.ColorResource(name: "LaunchPrimaryText", bundle: resourceBundle)

    /// The "LaunchSecondaryText" asset catalog color resource.
    static let launchSecondaryText = DeveloperToolsSupport.ColorResource(name: "LaunchSecondaryText", bundle: resourceBundle)
...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let launchAppIcon = DeveloperToolsSupport.ImageResource(thinnableName: "LaunchAppIcon", bundle: resourceBundle)
...
extension AppKit.NSColor {
    ...
    /// The "LaunchPrimaryText" asset catalog color.
    ...
    /// The "LaunchSecondaryText" asset catalog color.
...
extension AppKit.NSImage {
    ...
    /// The "LaunchAppIcon" asset catalog image.
    static var launchAppIcon: AppKit.NSImage? {
#if !targetEnvironment(macCatalyst)
        .init(thinnableResource: .launchAppIcon)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "LaunchAppIcon" asset catalog image.
    static var launchAppIcon: UIKit.UIImage? {
#if !os(watchOS)
        .init(thinnableResource: .launchAppIcon)
#else
        .init()
